...
adata_st_path = '../data/spatial_data.pickle'# '..//data/spatial_data_normcorrect.pickle' # '..//data/spatial_data.pickle' # '..//data/spatial_data_normcorrect.pickle' - previously used this, changed on nov 18, 2024
N_range = [25,  75,  125, 150, 175,  250] #[5, 10, 50,  100,  200,  400] #[5, 50, 500] # [5, 10, 20] # , 50, 75, 100, 150, 200, 250, 300, 350, 400, 450, 500] # [500] # [5, 10, 50] # [100, 250] # [500]   # [5, 10, 20, 50, 75, 100, 150, 200, 250, 300, 350, 400, 450, 500]
...
def run_simulations(N,  savesimdir, adata_st,  nswaps_nbd = 5, n_neigh = 10):
    ...
    _, _ = sim_multiple_slices_allsims_tissue_forbatch_nowarp(adata_st,
...
if __name__ == "__main__":
    ...
    # # save stat pickles 
    # with open(savesimdir + 'sim_stats_pct_cells_swapped.pickle', 'wb') as handle:
    #     pickle.dump(pct_cells_swapped, handle, protocol=pickle.HIGHEST_PROTOCOL)
    
    # with open(savesimdir + 'sim_stats_pct_spots_changed.pickle', 'wb') as handle:
    #     pickle.dump(pct_spots_changed, handle, protocol=pickle.HIGHEST_PROTOCOL)
