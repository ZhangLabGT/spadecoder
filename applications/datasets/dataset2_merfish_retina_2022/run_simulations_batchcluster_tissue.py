...
adata_st_path = '..//data/spatial_data.pickle' # _norm.pickle' # '..//data/spatial_data.pickle' # '..//data/spatial_data_normcorrect.pickle' # previos - changed on nove 18, ..//data/spatial_data_norm.pickle'
...
# nswaps_nbd_range =  [2, 5, 10, 20, 50, 100] # [5]
