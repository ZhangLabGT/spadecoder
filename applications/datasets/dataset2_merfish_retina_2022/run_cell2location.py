...
# par_dict = {'nswaps_nbd':[ 100] }# , 5,10  ,50]}
#             # 'N':[  10, 50,  100,  200]}   # 5

par_dict = { 'N':[100] }# , 10, 25,  75, 100]}#  125, 150, 175]}#  # 5 [ 5, 10, 50,  100,  200]
            # 'nswaps_nbd':[ 5, 10, 20]} # , 50, 100]}
...
def cell2location_run( nneigh, inf_aver, **kwargs):
    ...
    for entry3 in real_samples: # adata_spot_swap[key_name][0].keys(): # iterate over real input samples or slices  
        ...
        for entry0 in range(num_tissueslices+1): # iterate over simulated tissue slices for each input slice
            ...
            adata_spot = mod.export_posterior(adata_spot,sample_kwargs={ 'batch_size': mod.adata.n_obs}) # added batch size since otherwise it was crashing for dataset 1 
...
if __name__ == "__main__":
    # at and above 250 some spatial slices have only 1 spot so spadecoder was not run beyond 150
    # N_range =   [50] # , 10, 20, 50, 75, 100, 150]#, 250, 400, 500] # # [5], []  # [] #  # [50] # #  #  #  #   #  #  # [250, 400, 500]#[5, 10] #,  50, 100, 250, 500] # [5, 10, 20, 50, 75, 100, 150, 200, 250, 300, 350, 400, 450, 500]
    # N_range.reverse()
